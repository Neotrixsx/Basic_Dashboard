...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2018 at 12:00 PM
...
INSERT INTO `userinfo` (`userid`, `campany_name`, `category`, `countries`, `address`, `website`, `contact_person`, `email`, `phone`, `status`) VALUES
(1, 'test', 'Demo Test', 'Albania', 'test', 'testdemo.com', 'test person', 'test@test.com', '987654321', 1);
